...
Paraview_Output = ["temperature", "conductivity", "viscosity", "tidal_heating"]

Paraview_Output_Ini = ["temperature", "conductivity"]
...
if (np.log10(Ra_bot) < 7):       # Conduction
   z_div = 25
elif (np.log10(Ra_bot) < 8.5):  # Steady convection
   z_div = 50
elif (np.log10(Ra_bot) < 9.5):  # Less steady convection
   z_div = 75
...
eta_0 = 10.0**viscosity_exponent	# Pa.s
"""
:var: 
